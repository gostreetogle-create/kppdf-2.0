...
export interface IKpCompanySnapshot {
  ...
  templateName: string;
  kpType: KpType;
  assets: { kpPage1: string; kpPage2?: string; passport?: string; appendix?: string };
  texts: { headerNote?: string; introText?: string; footerText?: string; closingText?: string };
  requisites?: { inn?: string; kpp?: string; ogrn?: string; phone?: string; email?: string };
}
